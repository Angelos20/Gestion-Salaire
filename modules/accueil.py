from PySide6.QtWidgets import (
    QWidget, QFrame, QLabel, QVBoxLayout,QMainWindow,
    QHBoxLayout, QStackedWidget, QPushButton,QMessageBox,
)
...
class App(QMainWindow):
    ...
    def load_icon(self, path, size=20):
        pixmap = QPixmap(path)

        if pixmap.isNull():
            print("❌ Icon introuvable :", path)
    ...
    def _build_sidebar(self):
        ...
        self.btn_employes = QPushButton("  Employés")
        self.btn_salaires = QPushButton("  Salaires")
        self.btn_presences = QPushButton("  Présences")

        BASE_DIR = Path(__file__).resolve().parent.parent

        base_icon = str(BASE_DIR / "resources/icons")

        self.btn_dashboard.setIcon(self.load_icon(f"{base_icon}/dashboard.png"))
        self.btn_employes.setIcon(self.load_icon(f"{base_icon}/employe.png"))
        self.btn_salaires.setIcon(self.load_icon(f"{base_icon}/money.png"))
        self.btn_presences.setIcon(self.load_icon(f"{base_icon}/calendar.png"))
        ...
        for b in [self.btn_dashboard, self.btn_employes, self.btn_salaires, self.btn_presences]:
            ...
            b.setStyleSheet("""
                QPushButton {
                    ...
                    padding-left: 18px;    /* décale icône + texte ensemble */
                }
        ...
        btn_settings.setIcon(self.load_icon(f"{base_icon}/settings.png"))
        btn_quit.setIcon(self.load_icon(f"{base_icon}/exit.png"))
